...
public:
	...
	PhysBody* CreateLeftLever(int x, int y, int width, int height, int angle, bodyType type);
	PhysBody* CreateRightLever(int x, int y, int width, int height, int angle, bodyType type);
	PhysBody* CreateCircle(int x, int y, int radious, bodyType type);
	PhysBody* CreateCircleEnemy(int x, int y, int radious, bodyType type);
