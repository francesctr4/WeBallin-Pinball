...
App::App(int argc, char* args[]) : argc(argc), args(args)
{
	...
	sceneTitle = new SceneTitle(true);
...
bool App::PreUpdate()
{
	...
	for (item = modules.start; item != NULL && ret == true; item = item->next)
	{
		...
		ret = item->data->IsEnabled() ? item->data->PreUpdate() : true;
	}
...
bool App::DoUpdate()
{
	...
	for (item = modules.start; item != NULL && ret == true; item = item->next)
	{
		...
		ret = item->data->IsEnabled() ? item->data->Update(dt) : true;
	}
...
bool App::PostUpdate()
{
	...
	for (item = modules.start; item != NULL && ret == true; item = item->next)
	{
		...
		ret = item->data->IsEnabled() ? item->data->PostUpdate() : true;
	}
...
bool App::CleanUp()
{
	...
	while (item != NULL && ret == true)
	{
		ret = item->data->IsEnabled() ? item->data->CleanUp() : true;
		item = item->prev;
	}
...
bool App::LoadFromFile()
{
	...
	else
	{
		...
		while (item != NULL && ret == true)
		{
			ret = item->data->IsEnabled() ? item->data->LoadState(gameStateFile.child("save_state").child(item->data->name.GetString())) : true;
			item = item->next;
		}
	}
...
bool App::SaveToFile() 
{
	...
	while (item != NULL)
	{
		ret = item->data->IsEnabled() ? item->data->SaveState(saveStateNode.append_child(item->data->name.GetString())) : true;
		item = item->next;
	}
